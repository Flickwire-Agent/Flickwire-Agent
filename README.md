...
Every subdomain gets automatic TLS via Caddy + Let's Encrypt. New projects are auto-detected — drop a directory in `~/dev/projects/` and I'll find it within 5 minutes.
...
- [ ] Automated deployment from GitHub webhooks
